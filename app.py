...
def get_astrological_sign(month, day):
    if (month == 12 and day >= 22) or (month == 1 and day <= 19):
        return "Capricorn\
            You are disciplined, responsible, and ambitious. You are a natural achiever who\
        ...
        return "Aquarius\
            You are independent, innovative, and forward-thinking. You are a visionary who often challenges\
        ...
        return "Pisces\
            You are empathetic, dreamy, and intuitive. You are highly imaginative and often drawn to artistic \
        ...
        return "Aries: You are a pioneer, \
        ...
        return "Taurus\
            You are known for your love of comfort and stability.\
        ...
        return "Gemini\
            You are versatile and quick-witted. You love to learn new things and to share your knowledge with others. \
        ...
        return "Cancer\
            You are deeply emotional and intuitive, often picking up on the feelings of others. \
        ...
        return "Leo\
            You are a natural-born leader with a flair for the dramatic.\
        ...
        return "Virgo\
            You are meticulous, analytical, and highly practical. \
        ...
        return "Libra\
            You seek harmony, balance, and fairness in all areas of life. \
        ...
        return "Scorpio\
            You are known for your intensity and passion. \
        ...
        return "Sagittarius\
            You are adventurous, optimistic, and you are always seeking the bigger picture.\
